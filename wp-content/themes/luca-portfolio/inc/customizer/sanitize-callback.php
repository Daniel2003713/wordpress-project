 ...
 */
function luca_portfolio_sanitize_select( $input, $setting ) {
 ...
 * @param  string $input Selected input.
 */
function luca_portfolio_sanitize_checkbox( $input ) {

	// returns true if checkbox is checked.
	return ( ( isset( $input ) && true == $input ) ? true : false );
}

function luca_portfolio_sanitize_google_fonts( $input, $setting ) {
...
function luca_portfolio_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function luca_portfolio_sanitize_switch( $input ) {
	if ( true === $input ) {
		return true;
	} else {
		return false;
 ...
 * @param  string $setting Input setting.
 */
function luca_portfolio_sanitize_number_range( $input, $setting ) {
	$input = absint( $input );
