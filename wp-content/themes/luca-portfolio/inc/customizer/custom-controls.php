...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Luca_Portfolio_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
	 ...
	 */
	class Luca_Portfolio_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * Multi Input field
	 */
	class Luca_Portfolio_Multi_Input_Custom_control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<label class="customize_multi_input">
				...
				<a href="#" class="button button-primary customize_multi_add_field"><?php echo esc_html__( 'Add More', 'luca-portfolio' ); ?></a>
			</label>
			<?php
		}
	}
	 ...
	 */
	class Luca_Portfolio_Customize_Horizontal_Line extends WP_Customize_Control {
		/**
		 * Control Type
		 */
		public $type = 'hr';
     ...
     * Repeater Field
     */
    class Luca_Portfolio_Customize_Field_Repeater extends WP_Customize_Control {
        public $id;
        ...
        public function __construct( $manager, $id, $args = array() ) {
            ...
            $this->add_field_label = esc_html__( 'Add new field', 'luca-portfolio' );
            if ( ! empty( $args['add_field_label'] ) ) {
                $this->add_field_label = $args['add_field_label'];
            }

            $this->boxtitle = esc_html__( 'Customizer Repeater', 'luca-portfolio' );
        ...
        public function enqueue() {
            wp_enqueue_style( 'font-awesome', get_template_directory_uri().'/assets/css/font-awesome.css', array(), LUCA_PORTFOLIO_VERSION );
            wp_enqueue_style( 'luca-portfolio-customizer-repeater-admin-stylesheet', get_template_directory_uri().'/assets/css/admin-style.css', array(), LUCA_PORTFOLIO_VERSION );
            wp_enqueue_style( 'wp-color-picker' );
            wp_enqueue_script( 'luca-portfolio-customizer-customizer-repeater-script', get_template_directory_uri() . '/assets/js/customizer_repeater.js', array('jquery', 'jquery-ui-draggable', 'wp-color-picker' ), LUCA_PORTFOLIO_VERSION, true  );
            wp_enqueue_script( 'luca-portfolio-customizer-repeater-fontawesome-iconpicker', get_template_directory_uri() . '/assets/js/fontawesome-iconpicker.js', array( 'jquery' ), LUCA_PORTFOLIO_VERSION, true );
            wp_enqueue_style( 'luca-portfolio-customizer-repeater-fontawesome-iconpicker-script', get_template_directory_uri() . '/assets/css/fontawesome-iconpicker.min.css', array(), LUCA_PORTFOLIO_VERSION );
        }
                        ...
                        <div class="customizer-repeater-box-content-hidden">
                            ...
                            if($this->custom_repeater_color_control == true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Hover color','luca-portfolio' ), $this->id, 'custom_repeater_color_control' ),
                            ...
                            if($this->custom_repeater_color2_control == true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Color','luca-portfolio' ), $this->id, 'custom_repeater_color2_control' ),
                            ...
                            if($this->custom_repeater_title_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Title','luca-portfolio' ), $this->id, 'custom_repeater_title_control' ),
                            ...
                            if($this->custom_repeater_subtitle_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Subtitle','luca-portfolio' ), $this->id, 'custom_repeater_subtitle_control' ),
                            ...
                            if($this->custom_repeater_text_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Text','luca-portfolio' ), $this->id, 'custom_repeater_text_control' ),
                            ...
                            if($this->custom_repeater_link_control){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Link','luca-portfolio' ), $this->id, 'custom_repeater_link_control' ),
                            ...
                            if($this->custom_repeater_text2_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Text','luca-portfolio' ), $this->id, 'custom_repeater_text2_control' ),
                            ...
                            if($this->custom_repeater_link2_control){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Link','luca-portfolio' ), $this->id, 'custom_repeater_link2_control' ),
                            ...
                            if($this->custom_repeater_shortcode_control==true){
                                $this->input_control(array(
                                    'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Shortcode','luca-portfolio' ), $this->id, 'custom_repeater_shortcode_control' ),
                            ...
                            <button type="button" class="social-repeater-general-control-remove-field" <?php if ( $it == 0 ) {
                                ...
                                <?php echo esc_html__( 'Delete field', 'luca-portfolio' ); ?>
                            </button>
        ...
        private function icon_picker_control($value = '', $show = ''){
            ...
            <span class="customize-control-title">
                <?php echo esc_html__('Icon','luca-portfolio'); ?>
            </span>
                <span class="description customize-control-description">
                <?php printf( __( 'Note: Some icons may not be displayed here. You can see the full list of icons at %s', 'luca-portfolio' ), 'http://fontawesome.io/icons/' ); ?>
            </span>
        ...
        private function image_control($value = '', $show = '', $attrs = array()){ ?>
            ...
            <span class="customize-control-title">
                <?php printf(__('%s', 'luca-portfolio'), $attrs['label']); ?>
            </span>
                <input type="text" name="<?php echo esc_attr($attrs['name']) ?>" class="widefat custom-media-url <?php printf(__('%s', 'luca-portfolio'), $attrs['class']); ?>" value="<?php printf(__('%s', 'luca-portfolio'), esc_attr( $value )); ?>">
                <input type="button" class="button button-secondary customizer-repeater-custom-media-button" value="<?php printf(__('Upload Image', 'luca-portfolio'), $attrs['class']); ?>" />
            </div>
            <?php
        }

        private function icon_type_choice($value='customizer_repeater_icon'){ ?>
            <span class="customize-control-title"><?php esc_html__('Image type','luca-portfolio');?></span>
            <select class="customizer-repeater-image-choice">
                <option value="customizer_repeater_icon" <?php selected($value,'customizer_repeater_icon');?>><?php esc_html__('Icon','luca-portfolio'); ?></option>
                <option value="customizer_repeater_image" <?php selected($value,'customizer_repeater_image');?>><?php esc_html__('Image','luca-portfolio'); ?></option>
                <option value="customizer_repeater_none" <?php selected($value,'customizer_repeater_none');?>><?php esc_html__('None','luca-portfolio'); ?></option>
            </select>
            <?php
        }
        ...
        private function icon_type_radio($value, $field){ ?>
            <span class="customize-control-title">
                <?php printf( __( '%s', 'luca-portfolio' ), $field['label']);?>
            </span>
        ...
        private function repeater_control($value = ''){
            ...
            $show_del        = 0; ?>
            <span class="customize-control-title"><?php echo esc_html__( 'Social icons', 'luca-portfolio' ); ?></span>
            <?php
            '<span class="description customize-control-description">';
                printf(__('Note: Some icons may not be displayed here. You can see the full list of icons at %s', 'luca-portfolio'), 'http://fontawesome.io/icons/');
            echo '</span>';
            if(!empty($value)) {
            ...
            if ( ( count( $social_repeater ) == 1 && '' === $social_repeater[0] ) || empty( $social_repeater ) ) { ?>
                <div class="customizer-repeater-social-repeater">
                    <div class="customizer-repeater-social-repeater-container">
                        ...
                        <?php get_template_part( $this->custom_icon_container ); ?>
                        <input type="text" class="customizer-repeater-social-repeater-link" placeholder="<?php esc_attr_e( 'Link', 'luca-portfolio' ); ?>">
                        <input type="hidden" class="customizer-repeater-social-repeater-id" value="">
                        <button class="social-repeater-remove-social-item" style="display:none">
                            <?php esc_html__( 'Remove Icon', 'luca-portfolio' ); ?>
                        </button>
                    </div>
                    <input type="hidden" id="social-repeater-socials-repeater-colector" class="social-repeater-socials-repeater-colector" value=""/>
                </div>
                <button class="social-repeater-add-social-item button-secondary"><?php esc_html__( 'Add Icon', 'luca-portfolio' ); ?></button>
                <?php
            } else { ?>
                <div class="customizer-repeater-social-repeater">
                    <?php
                    foreach ( $social_repeater as $social_icon ) {
                        ...
                        <div class="customizer-repeater-social-repeater-container">
                            ...
                            <input type="text" class="customizer-repeater-social-repeater-link"
                                   placeholder="<?php esc_attr_e( 'Link', 'luca-portfolio' ); ?>"
                            ...
                            <button class="button-primary social-repeater-remove-social-item" style="<?php if ( $show_del == 1 ) {echo "display:none";} ?>"><?php esc_html__( 'Remove Icon', 'luca-portfolio' ); ?></button>
                        </div>
                        <?php
                    } ?>
        ...
        private function repeater_fields($value = '', $data = array()) {
            ...
            ?>
            <span class="customize-control-title"><?php printf(__('%s', 'luca-portfolio'), $data['label'][0]); ?></span>
            <div class="customizer-repeater-field" data-key="<?php printf(__('%s', 'luca-portfolio'), $data['key']); ?>">
                ...
                <div class="customizer-repeater-field__group">
                            ...
                            <div class="customizer-repeater-field__item">
                                <?php
                                    if($item['type'] == 'textarea') {
                                        $this->input_control( array(
                                            'label' => apply_filters('repeater_input_labels_filter', sprintf(__('%s', 'luca-portfolio'), $item['label']), $this->id, 'custom_repeater_link_control' ),
                                            'class' => $item['class'],
                                            'name'  => $name,
                                            'type' => $item['type'],
                                        ...
                                        ?>
                                        <span class="customize-control-title">
                                            <?php printf( __( '%s', 'luca-portfolio' ), $item['label']);?>
                                        </span>
                    ...
                    ?>
                    <?php
                        $item_delete = esc_attr( 'Remove Item', 'luca-portfolio' );
                ...
                <?php
                $item_add = esc_attr( 'Add Item', 'luca-portfolio' );
     ...
     * Select Multiple
     */
    class Luca_Portfolio_Customize_Select_Multiple extends WP_Customize_Control {
        /**
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Luca_Portfolio_Custom_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'luca-portfolio-upsell';
		...
		protected function render() {
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="luca_portfolio_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
				<h3 class="accordion-section-title" tabindex="0" style="">
					<?php echo esc_html( $this->title ); ?>
					<a href="<?php echo esc_url( $this->url ); ?>" class="button button-secondary alignright" target="_blank" style="margin-top: -3px;margin-right: -20px;"><?php echo esc_html( $this->button_text ); ?></a>
				</h3>
			</li>
			<?php
		}
