;(function () {
    ...
    var nav = function () {
        ...
        if(isMobile()){
            ...
            $('.header__social ul.social > li:last-child').keydown(function(event) {
                if (event.which == 9) {
                    $('body').removeClass('nav-open-js');
                }
            });
        ...
        var height_header_inner = $('.header_inner').outerHeight();
        $('.header--fixed').css({'height': height_header_inner});
    }
